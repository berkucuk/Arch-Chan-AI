...
class ChatBotGUI(QWidget):
    def __init__(self):
        ...
        self.setWindowTitle('Linux Chan AI')
    ...
    def setup_image(self, layout):
        # Fotoğrafı yükle
        pixmap = QPixmap("/usr/share/Linux-Chan-AI/icons/kali-chan.png")
    ...
    def handle_response(self, result):
        ...
        if agent_type == "linux_command":
            ...
            self.chat_display.append(f"Linux Chan: Command: {cmd}\nDescription: {description}\nTerminal Output: {terminal_output}\n")
        elif agent_type == "weather_gether":
            self.chat_display.append(f"Linux Chan: {response}\n")
...
if __name__ == '__main__':
    ...
    app.setWindowIcon(QIcon('/usr/share/Linux-Chan-AI/icons/kali-chan_mini.png'))
